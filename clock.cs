...
class Clock
{
    ...
    public delegate void setDate(Bitmap time, String month,String yr,int dayweek);
    public void getTime()
    {
        ...
        while (runLoop)
        {
            try
            {
                ...
                frame.BeginInvoke(new setDate(frame.setDate), new Object[] { days[daynum], DateTime.Now.ToString("MMMM"), DateTime.Now.ToString("yyyy"),DateTime.Now.DayOfWeek});
